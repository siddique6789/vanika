              ...
              {productData.map((product) => (
                <div className="col-sm-6 col-md-6" key={product.id} data-aos="fade-up" data-aos-delay={product.id * 100}>
                  ...
                  <Link to={`/product/${product.id}`} className="text-decoration-none text-dark">
                    <div
                      className="card h-100 shadow border-0 rounded-4 product-card position-relative"
                      style={{
                    ...
                    >
                      ...
                      <div className="card-body d-flex flex-column text-center position-relative">
                        ...
                        <div className="mt-auto">
                          ...
                          <span className="btn btn-outline-success w-100 rounded-pill stretched-link">View Details</span>
